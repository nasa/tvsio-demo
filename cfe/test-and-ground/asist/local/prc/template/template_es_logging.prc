...
;                                       the host IP.
;       10/17/17        W. Moleski      Updated for 6.6.0 testing using new
;                                       macro (#define) names.
;
;  Arguments
;	None 
...
write ";*********************************************************************"
;; CFE_PLATFOPM_ES_SYSTEM_LOG_SIZE defines the MAX size of the System Log
...
write "; Max System Log size = ", CFE_PLATFORM_ES_SYSTEM_LOG_SIZE 
...
if ($SC_$CPU_ES_SYSLOGBYTEUSED < CFE_PLATFORM_ES_SYSTEM_LOG_SIZE) then
  ...
  while ($SC_$CPU_ES_SYSLOGBYTEUSED < CFE_PLATFORM_ES_SYSTEM_LOG_SIZE) do
...
write "; Maximum ER Log Entries = ",CFE_PLATFORM_ES_ER_LOG_ENTRIES
...
if ($SC_$CPU_ES_ERLOGINDEX < CFE_PLATFORM_ES_ER_LOG_ENTRIES) then
  ...
  entriesToFill = CFE_PLATFORM_ES_ER_LOG_ENTRIES - $SC_$CPU_ES_ERLOGINDEX 
...
wait until ($SC_$CPU_ES_PerfDataCnt = CFE_PLATFORM_ES_PERF_DATA_BUFFER_SIZE)
s load_start_app ("TST_ES", hostCPU)
wait 5
