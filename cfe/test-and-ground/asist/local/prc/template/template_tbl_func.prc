...
;; Display the appropriate pages
page $SC_$CPU_TBL_HK
page $SC_$CPU_TBL_REGISTRY
page $SC_$CPU_TBL_REG_INFO
page $SC_$CPU_TST_TBL_TABLE1
page $SC_$CPU_TST_TBL_TABLE2
...
;; CPU1 is the default
;;;;;  Buffer flag is     xxxx
rawcmd = "1804c0000029043611115453545F54424C2E64666C745F74626C5F303100000000000000000000000000000000000000000000"
...
;;; Verify the Commanded Table Verification Function Result
if ($SC_$CPU_TBL_LASTVALS = -1) then
  write "<*> Passed (6011J) - Verification Result reported '",$SC_$CPU_TBL_LASTVALS, "' in TLM which indicates failure as expected."
  ut_setrequirements TS_6011j, "P"
else
  write "<!> Failed (6011J) - Verification Result reported '",$SC_$CPU_TBL_LASTVALS, "' in TLM which indicates success when failure was expected."
  ut_setrequirements TS_6011j, "F"
endif
...
for app_info_file_index = 1 to CFE_PLATFORM_ES_MAX_APPLICATIONS do
...
;;; Check the number of tables counter
ut_tlmwait $SC_$CPU_TBL_NUMTABLES, CFE_PLATFORM_TBL_MAX_NUM_TABLES
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (6011C) - As expected, the table counter = ",CFE_PLATFORM_TBL_MAX_NUM_TABLES
  ut_setrequirements TS_6011c, "P"
else
  write "<!> Failed (6011C) - Table counter expected ",CFE_PLATFORM_TBL_MAX_NUM_TABLES,"; telemetry reports '", $SC_$CPU_TBL_NUMTABLES,"'."
  ut_setrequirements TS_6011c, "F"
endif
...
write ";**********************************************************************"
write "; Step 19.0: Command a Power-On Reset on ",hostCPU
write ";*********************************************************************"
/$SC_$CPU_ES_POWERONRESET
wait 10
