...
;       10/26/17	Walt Moleski	Updated for 6.6.0 testing using CPU1 for
...
LOCAL maxroute = CFE_PLATFORM_SB_MAX_MSG_IDS
LOCAL routefound
LOCAL msgid
LOCAL i, j, k
LOCAL no_sub_ctr
...
write ";*********************************************************************"
write ";  Step 1.1:  Perform a Power-on Reset on ",hostCPU
write ";********************************************************************"
...
for app_info_file_index = 1 to CFE_MISSION_ES_MAX_APPLICATIONS do
