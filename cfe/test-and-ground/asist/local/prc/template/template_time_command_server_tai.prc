...
;	10/28/17	W. Moleski	Updatred for cFE 6.6
;
;  Arguments
;	 None 
;
...
start load_start_app ("TST_TIME", hostCPU)
wait 10
...
IF CFE_MISSION_TIME_CFG_DEFAULT_TAI THEN
...
IF CFE_MISSION_TIME_CFG_DEFAULT_UTC THEN
