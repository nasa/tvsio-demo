...
cmdCtr = $SC_$CPU_TST_SB_MSGCTR+(CFE_PLATFORM_SB_MAX_DEST_PER_PKT-1)
write "*** Expecting message counter to be $SC_$CPU_TST_SB_MSGCTR+(CFE_PLATFORM_SB_MAX_DEST_PER_PKT-1) = ", $SC_$CPU_TST_SB_MSGCTR,"+(", CFE_PLATFORM_SB_MAX_DEST_PER_PKT,"-1)."
...
cmdCtr = $SC_$CPU_TST_SB_MSGCTR+CFE_PLATFORM_SB_MAX_DEST_PER_PKT
...
for i=1 to CFE_PLATFORM_SB_MAX_PIPES do
   for pipenum=0 to CFE_PLATFORM_SB_MAX_PIPES do
...
if (numFound = (CFE_PLATFORM_SB_MAX_PIPES-numberOfInitialPipes)) then
   write "<*> Passed (4301) - found ", numFound, " pipes."
   ut_setrequirements cSB4301, "P"
else
   write "<!> Failed (4301) - found ", numFound, " pipes. Expected ", (CFE_PLATFORM_SB_MAX_PIPES-numberOfInitialPipes), "."
