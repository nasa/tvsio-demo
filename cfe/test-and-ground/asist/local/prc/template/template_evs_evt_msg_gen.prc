...
GLOBAL SAVE_EVS_AppData_EventCounter[CFE_PLATFORM_ES_MAX_APPLICATIONS]
GLOBAL SAVE_EVS_AppData_AppName[CFE_PLATFORM_ES_MAX_APPLICATIONS]
GLOBAL SAVE_EVS_AppData_ActiveFlag[CFE_PLATFORM_ES_MAX_APPLICATIONS]
GLOBAL SAVE_EVS_AppData_EvtTypeAF_Debug[CFE_PLATFORM_ES_MAX_APPLICATIONS]
GLOBAL SAVE_EVS_AppData_EvtTypeAF_Info[CFE_PLATFORM_ES_MAX_APPLICATIONS]
GLOBAL SAVE_EVS_AppData_EvtTypeAF_Err[CFE_PLATFORM_ES_MAX_APPLICATIONS]
GLOBAL SAVE_EVS_AppData_EvtTypeAF_Crit[CFE_PLATFORM_ES_MAX_APPLICATIONS] 
 
GLOBAL SAVE_EVS_AppData_BinFltr_EvtId[CFE_PLATFORM_ES_MAX_APPLICATIONS,CFE_PLATFORM_EVS_MAX_EVENT_FILTERS] 
GLOBAL SAVE_EVS_AppData_BinFltr_Msk[CFE_PLATFORM_ES_MAX_APPLICATIONS,CFE_PLATFORM_EVS_MAX_EVENT_FILTERS]
GLOBAL SAVE_EVS_AppData_BinFltr_Ctr[CFE_PLATFORM_ES_MAX_APPLICATIONS,CFE_PLATFORM_EVS_MAX_EVENT_FILTERS]
...
for i = 1 to CFE_PLATFORM_ES_MAX_APPLICATIONS do
...
FOR i = 1 to CFE_PLATFORM_ES_MAX_APPLICATIONS DO
  ...
  FOR j = 1 to CFE_PLATFORM_EVS_MAX_EVENT_FILTERS DO
...
write ";	   string length is greater than the defined value of ", CFE_MISSION_EVS_MAX_MESSAGE_LENGTH
