...
if ($SC_$CPU_TBL_NumTables = CFE_PLATFORM_TBL_MAX_NUM_TABLES) then
  write "<*> Passed - The number of tables is as expected."
else
  write "<!> Failed - TLM indicates  ", $SC_$CPU_TBL_NUMTables, " registered. This should have been ",CFE_PLATFORM_TBL_MAX_NUM_TABLES,"."
endif
...
local cdsRegIdx = 0
for cds_index = 1 to CFE_PLATFORM_ES_CDS_MAX_NUM_ENTRIES do
...
if (($SC_$CPU_find_event[1].num_found_messages = 1) .OR. ;;
...
write ";**********************************************************************"
write "; Step 6.0: Command a Power-On Reset on ",hostCPU
write ";*********************************************************************"
/$SC_$CPU_ES_POWERONRESET
wait 10
