...
start load_start_app ("TST_TBL", hostCPU, "TST_TBL_TaskMain")
...
start load_start_app ("TST_TBL2", hostCPU, "TST_TBL2_TaskMain")
...
wait 5
start get_file_to_cvt (ramDir, "cfe_tbl_reg.log", "$sc_$cpu_tbl_reg.log", hostCPU)
wait 20
