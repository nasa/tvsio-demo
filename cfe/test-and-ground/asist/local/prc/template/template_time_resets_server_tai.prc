...
;       10/26/17        W. Moleski      Updates for cFE 6.6
;
;  Arguments
;	 None 
;
...
s load_start_app ("TST_TIME", hostCPU)
wait 10
...
write "Default Leap Seconds = ", CFE_MISSION_TIME_DEF_LEAPS
write "Default STCF Seconds = ", CFE_MISSION_TIME_DEF_STCF_SECS
write "Default STCF SubSeconds = ", CFE_MISSION_TIME_DEF_STCF_SUBS
...
IF ($SC_$CPU_TIME_DLEAPS = CFE_MISSION_TIME_DEF_LEAPS) THEN
  write "<*> Passed (2500) - Leap Seconds set to Default."
  ut_setrequirements cTIME2500, "P"
ELSE
  write "<!> Failed (2500) - Leap Seconds set to ",$SC_$CPU_TIME_DLEAPS, ";expected ",CFE_MISSION_TIME_DEF_LEAPS
  ut_setrequirements cTIME2500, "F"
ENDIF

IF ($SC_$CPU_TIME_DSTCFS = CFE_MISSION_TIME_DEF_STCF_SECS) THEN
  write "<*> Passed (2500) - STCF Seconds set to Default."
  ut_setrequirements cTIME2500, "P"
ELSE
  write "<!> Failed (2500) - STCF Seconds set to ",$SC_$CPU_TIME_DSTCFS, "; expected ",CFE_MISSION_TIME_DEF_STCF_SECS
  ut_setrequirements cTIME2500, "F"
ENDIF

IF ($SC_$CPU_TIME_DSTCFSS = CFE_MISSION_TIME_DEF_STCF_SUBS) THEN
  write "<*> Passed (2500) - STCF SubSeconds set to Default."
  ut_setrequirements cTIME2500, "P"
ELSE
  write "<!> Failed (2500) - STCF SubSeconds set to ",$SC_$CPU_TIME_DSTCFSS, "; expected ",CFE_MISSION_TIME_DEF_STCF_SUBS
  ut_setrequirements cTIME2500, "F"
ENDIF
