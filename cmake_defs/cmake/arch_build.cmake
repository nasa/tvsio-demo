...
function(add_cfe_tables APP_NAME TBL_SRC_FILES)
  ...
  foreach(TBL ${TBL_SRC_FILES} ${ARGN})
    ...
    foreach(TGT ${APP_INSTALL_LIST})
      ...
      find_file(TBL_SRC 
                NAMES ${TBLWE}.c
                PATHS ${MISSION_DEFS}/${TGT}/tbls 
                      ${MISSION_DEFS}/shared ${MISSION_DEFS}/shared/tbls
                      NO_DEFAULT_PATH)
...
function(prepare)
  ...
  if (EXISTS "${MISSION_DEFS}/${TARGETSYSTEM}/cfgs/${TARGETSYSTEM}_osconfig.h")
      generate_config_includefile("inc/osconfig.h" osconfig.h ${TARGETSYSTEM}/cfgs/${TARGETSYSTEM})
  else ()
      generate_config_includefile("inc/osconfig.h" osconfig.h shared/cfgs/default)
  endif()
  message("")
  ...
  foreach(TGTID ${TGTSYS_${SYSVAR}})
    ...
    message("")
      ...
      foreach (TGTHEADER ${TGTHEADERS})
         ...
         generate_config_includefile(${INSTALLPATH} ${SUFFIX} ${TGTNAME}/cfgs/${PREFIX} ${TGTNAME}/${PREFIX} shared/${PREFIX} shared/cfgs/${PREFIX} ${PREFIX})
      endforeach()
      message("")
    ...
    foreach(INSTFILE ${TGT${TGTID}_FILELIST})
      ...
      if(${FILESRC} STREQUAL "FILESRC-NOTFOUND")
        ...
        set (_resolvedFiles "")
        foreach (_file ${FILESRC})
            get_filename_component(_resolvedFile "${FILESRC}" REALPATH)
            list (APPEND _resolvedFiles "${_resolvedFile}")
        endforeach()
        install(FILES ${_resolvedFiles} DESTINATION ${TGTNAME}/${INSTALL_SUBDIR} RENAME ${INSTFILE})
