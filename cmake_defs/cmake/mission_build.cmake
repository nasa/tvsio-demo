...
function(process_arch TARGETSYSTEM)
  message("In mission_build::process_arch")
  ...
  if (NOT CURRSYS STREQUAL "native" AND NOT EXISTS "${ARCH_BINARY_DIR}/CMakeCache.txt")
    ...
    if (EXISTS ${MISSION_DEFS}/${CURRSYS}/toolchain-${CURRSYS}.cmake)
      set(TOOLCHAIN_FILE ${MISSION_DEFS}/${CURRSYS}/toolchain-${CURRSYS}.cmake)
    elseif(EXISTS ${CMAKE_SOURCE_DIR}/cmake_defs/toolchains/toolchain-${CURRSYS}.cmake)
      set(TOOLCHAIN_FILE ${CMAKE_SOURCE_DIR}/cmake_defs/toolchains/toolchain-${CURRSYS}.cmake)
    elseif(EXISTS ${MISSION_SOURCE_DIR}/cmake_defs/toolchains/toolchain-${TGT${TGTSYS_${CURRSYS}}_SYSTEM}.cmake)
      set(TOOLCHAIN_FILE ${MISSION_SOURCE_DIR}/cmake_defs/toolchains/toolchain-${TGT${TGTSYS_${CURRSYS}}_SYSTEM}.cmake)
    else()
      message(FATAL_ERROR "Unable to find toolchain file for ${CURRSYS}")
    endif()
    message(STATUS "Target \"${CURRSYS}\" : Selected toolchain file ${TOOLCHAIN_FILE}")
