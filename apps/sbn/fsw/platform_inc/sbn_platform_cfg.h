...
#define SBN_MAX_PEERNAME_LENGTH     64
...
#define SBN_PEER_PIPE_DEPTH           256
...
#define SBN_VOL_PEER_FILENAME         "/cf/SbnPeerData.dat" //was previously /ram/ should this be changed? why is it assuming we are volatile memory?
...
#define SBN_VOL_MODULE_FILENAME       "/cf/SbnModuleData.dat"
...
#define SBN_SCH_PIPE_DEPTH            64

#define SBN_MOD_STATUS_MSG_SIZE       128 /* bytes */

#define SBN_REMAP_FILENAME  "/cf/sbn_remap_tbl.tbl"
#define SBN_PROTOBETTER_FILENAME "/cf/sbn_protobetter_tbl.tbl"

#define SBN_REMAP_TABLE_SIZE 128
#define SBN_PROTOBETTER_TABLE_SIZE 128
