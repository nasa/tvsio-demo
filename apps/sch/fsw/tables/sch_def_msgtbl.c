...
SCH_MessageEntry_t SCH_DefaultMessageTable[SCH_MAX_MESSAGES] =
{
  ...
  */
  ...
  { SCH_UNUSED_MID },
    /* command ID #34 */
  { SCH_UNUSED_MID },
  /* { { CFE_MAKE_BIG16(NETWK_HS_SEND_HK_MID), CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } }, */
    /* command ID #35 */
  { SCH_UNUSED_MID },
  /* { { CFE_MAKE_BIG16(NETWK_HS_WAKEUP_MID), CFE_MAKE_BIG16(0xC000), CFE_MAKE_BIG16(0x0001), 0x0000 } }, */
    /* command ID #36 */
  { SCH_UNUSED_MID },
  /* command ID #37 */
  { SCH_UNUSED_MID },
