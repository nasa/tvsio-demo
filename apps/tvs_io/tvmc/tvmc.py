...
class TvsIoMapping:
	...
	if commandCode is not None:
		...
		self.PackFunctionName = self.PackFunctionName + "_" + str(commandCode)
		self.UnpackFunctionName = self.UnpackFunctionName + "_" + str(commandCode)
...
def main():
    ...
    for tvmFilePath in tvm_files:
        ...
        if nMembers == 0:
            ...
            print("TVMC WARNING: No members found for type " + cfsStructureType + " in " + tvmFilePath)
        ...
        for x in range(0, nMembers):
            ...
            if trickType.startswith("char"):
                ...
                print("TVS_IO ERROR: encountered unknown Trick type '" + trickType + "' for " + cfsStructureType + " type in " + tvmFilePath)
                exit()
