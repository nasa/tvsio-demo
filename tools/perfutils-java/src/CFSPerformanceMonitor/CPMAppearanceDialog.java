...
public class CPMAppearanceDialog extends CPMDialogHandler
{
    ...
    private void initialize()
    {
        ...
        {
            /**************************************************************************************
             * Select the look & feel to use based on the radio button selection
             *************************************************************************************/
            @Override
            public void actionPerformed(ActionEvent ae)
            {
                ...
                {
                    // Save the selected look & feel name for storage in the program preferences
                    // backing store and implement it
                    perfMain.setLookAndFeel(((JRadioButton) ae.getSource()).getText());

                    // Update this dialog so that it uses the selected look & feel. The button
                    // sizes must be recalculated and the dialog packed since each look & feel
                    // changes the sizes of components
        ...
        // Display the Application Appearance dialog and wait for the user to select the Okay
        // button
