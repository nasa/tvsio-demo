/**
 * CFS Performance Monitor Modified JFreeChart XYStepRenderer class - allows shading of the area
 * below a step line, speeding up of the plot rendering, and hiding the horizontal lines between
...
public class CPMXYStepRenderer extends XYStepRenderer
{
                                ...
                                double y1)
    {
        ...
        // Check if the two data points encompass a gap in the log data (due to multiple log
        // files); don't fill the gap area
        if (gapFlag)
        {
            // Check if there is any space between the starting point and the start of the gap
            if (x0 < x0gap)
            {
                // Set the four corners of the shaded rectangle starting with the first point and
                // stopping at the beginning of the gap
            ...
            // Check is there is any space between the end of the gap and the ending point
            if (x1 > x1gap)
            {
                // Set the four corners of the shaded rectangle starting with the end of the gap
                // and stopping at the second point
        ...
        {
            // Set the four corners of the shaded rectangle starting at the first point and
                         ...
                         int series, int item, CrosshairState crosshairState, int pass)
    {
        ...
        if (pass == 0 && item > 0)
        {
            ...
            {
                /**
                 * Note: The code below allows plotting of the step lines either horizontally or
                 * vertically. CPM only plots horizontally so this code is commented out
                 */
                ...
                for (int index = 0; index < perfLog.getDataGapIndex().size(); index++)
                {
                    ...
                    {
                        // Store the x-coordinates of the beginning and ending of the gap; the
                        // values are adjusted by 1 to prevent shading over a plot line
                ...
                if (transY0 == transY1)
                {
                    ...
                    // Check if this horizontal line is not at the exit event level (i.e., between
                    // an exit and enter event). If it is, check if showing these lines is enabled
                    ...
                    // Check if the user has shading enabled and that both of the y-values are
                    // entry events (= 1). This accounts for two entry events occurring without an
                    // intervening exit event, and also if the last y-value is an exit event
            ...
            // Store the second x-coordinate of this point pair for comparison on the next pass
            prevX1 = (int) transX1;
