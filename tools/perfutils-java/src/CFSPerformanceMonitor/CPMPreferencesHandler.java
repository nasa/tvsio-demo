...
public class CPMPreferencesHandler
{
    ...
    // Shade or don't shade the area between the entry and exit events on the step sub-plots
    ...
    // Sort order of the data in the statistics plot (low to high); by ID/name or value
    private int sortOrder;

    // Show/hide the gaps in the log data caused when multiple log files have been read
    private boolean showDataGaps;

    // Show/hide frame overrun indicators on the step and thread of execution plots
     ...
     *
     * @param useDefault
     *            true to return the default step plot height; false to return the current step
     *            plot height
     *
     ...
     *
     * @param useDefault
     *            true to return the default step plot spacing; false to return the current step
     *            plot spacing
     *
     ...
     *
     * @param useDefault
     *            true to return the default show step labels flag; false to return the current
     *            show step labels flag
     *
     ...
     *
     * @param useDefault
     *            true to return the default show step shading flag; false to return the current
     *            show step shading flag
     *
     * @return true if the step labels are displayed
     *********************************************************************************************/
     ...
     *
     * @param useDefault
     *            true to return the default show step exit line flag; false to return the current
     *            show step exit line flag
     *
     * @return true if the step lines between exit and enter events are displayed
     *********************************************************************************************/
     ...
     *
     * @param useDefault
     *            true to return the default show plot horizontal grid flag; false to return the
     *            current show plot horizontal grid flag
     *
     ...
     *
     * @param useDefault
     *            true to return the default show plot vertical grid flag; false to return the
     *            current show plot vertical grid flag
     *
     ...
     *
     * @param useDefault
     *            true to return the default show minor frame lines flag; false to return the
     *            current show minor frame lines flag
     *
     ...
     *
     * @param useDefault
     *            true to return the default show major frame lines flag; false to return the
     *            current show major frame lines flag
     *
     ...
     *
     * @param useDefault
     *            true to return the default minor frame ID; false to return the current minor
     *            frame ID
     *
     ...
     *
     * @param useDefault
     *            true to return the default major frame ID; false to return the current major
     *            frame ID
     *
     ...
     *
     * @param useDefault
     *            true to return the default statistics chart type; false to return the current
     ...
     *
     * @param useDefault
     *            true to return the default show CPU idle flag; false to return the current show
     *            CPU idle flag
     *
     ...
     *
     * @param useDefault
     *            true to return the default statistics plot data sort order; false to return the
     *            current statistics plot data sort order
     *
     ...
     *
     * @param useDefault
     *            true to return the default show data gaps flag; false to return the current show
     *            data gaps flag
     *
     ...
     *
     * @param useDefault
     *            true to return the default show overruns flag; false to return the current show
     *            overruns flag
     *
     ...
     *
     * @param useDefault
     *            true to return the default plot background color; false to return the current
     *            plot background color
     *
     ...
     *
     * @param useDefault
     *            true to return the default plot major grid line color; false to return the
     *            current plot major grid line color
     *
     ...
     *
     * @param useDefault
     *            true to return the default plot minor grid line color; false to return the
     *            current plot minor grid line color
     *
     ...
     *
     * @param useDefault
     *            true to return the default minor frame line color; false to return the current
     ...
     *
     * @param useDefault
     *            true to return the default major frame line color; false to return the current
    ...
    /**********************************************************************************************
     * Create a string representing the current user-selected application preferences (used when
     * saving a configuration to the program preferences backing store)
     *
    ...
    /**********************************************************************************************
     * Parse the configuration entry from the program preferences backing store to obtain the user-
     * selected plot preferences
     *
     * @param parts
    ...
    {
        // Set the user-selectable plot preferences. The use of the switch statement allows
        // additions to the configurable parameters while maintaining backwards compatibility to
        // previously saved configurations that would lack the new parameters
        switch (parts.length)
        {
            case 21:
