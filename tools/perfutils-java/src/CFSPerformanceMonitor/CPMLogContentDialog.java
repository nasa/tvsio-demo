...
public class CPMLogContentDialog extends CPMDialogHandler
{
    ...
    // Define the performance log table globally so that it can be accessed by the action
    // listeners, etc.
    ...
    private void initialize()
    {
        ...
        {
            /**************************************************************************************
             * Override isCellEditable so that only the Notes column can be edited
             *************************************************************************************/
            @Override
            ...
            protected void handleCellContentChange(int row,
                                                   ...
                                                   Object newValue)
            {
                // Store the log note with the log data and write it to the log notes file
            ...
            protected void loadAndFormatData()
            {
                ...
                // Create the output format string for the time stamps so that the decimals align
                ...
                // Place the log data into the table model along with the column names, set up the
        ...
        // Create an outer panel to put the log panel in. The border doesn't appear without this
    ...
    /**********************************************************************************************
     * External method to reload the log data into the tables and reformat the table cells
     *********************************************************************************************/
