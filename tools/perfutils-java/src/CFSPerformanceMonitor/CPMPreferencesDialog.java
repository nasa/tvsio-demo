...
public class CPMPreferencesDialog extends CPMDialogHandler
{
    ...
    private JComboBox<String> minorIDComboBox;
    private JComboBox<String> majorIDComboBox;
     ...
     *
     * @param useDefaults
     *            true to set the dialog controls to the default preference values; false to set
     *            the controls to the current preference values
     *********************************************************************************************/
    ...
    private void createPreferencesDialog()
    {
        ...
        // Display the Preferences dialog and update the preference values based on the user's
        // actions
        updatePreferences();
    }
    ...
    private String[] createIDNameList()
    {
        ...
        for (PerformanceID pid : perfIDs.getPerfIDList())
        {
            ...
            {
                // Save the minor frame ID so that it can be automatically selected in the minor
                // frame combo box
                minorIDText = idText;
            }
            ...
            {
                // Save the major frame ID so that it can be automatically selected in the major
                // frame combo box
                majorIDText = idText;
            }
    ...
    {
        // Create a flag that is true if the minor/major frame inputs are enabled
        ...
        // Use an outer panel so that the components can be easily forced to the top of the tab
        // area
        ...
        minorIDComboBox = new JComboBox<String>(idNames);
        ...
        majorIDComboBox = new JComboBox<String>(idNames);
        ...
        heightSlider.addMouseWheelListener(new MouseWheelListener()
        {
            ...
            {
                // Adjust the new slider position based on mouse wheel rotation direction. The
                // slide "speed" is reduced by half to make finer adjustment possible
        ...
        // Create a checkbox for showing/hiding the step lines between exit and enter events
        ...
        // Create the sort buttons label, then position the label and buttons relative to each
        // other
        ...
        // detected. This is needed to provide focus indicators for the color selection check boxes
        KeyboardFocusManager.getCurrentKeyboardFocusManager().addPropertyChangeListener(new PropertyChangeListener()
        {
            Component focusOwner;

            /**************************************************************************************
             * Highlight a color check box if it has the keyboard focus and remove the highlight
             * when it loses focus
             *************************************************************************************/
            @Override
            public void propertyChange(PropertyChangeEvent pce)
            {
                // Turn off color check box highlight when it no longer has focus
    ...
    /**********************************************************************************************
     * Display the plot preferences dialog and update the preferences based on the user's actions
     *********************************************************************************************/
    private void updatePreferences()
    {
        // Display the Plot Preferences dialog and wait for the user to select the Okay or Cancel
        // button. If Okay is chosen update the plots
    ...
    /**********************************************************************************************
     * Check for changes and update the step and thread of execution plot background and grid line
     * colors
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Check for changes and update the step plot's subplot height and spacing, and display of the
     * y-axis tick labels, shading, and lines between the exit and enter events
     *********************************************************************************************/
    ...
    private void updateDataGap()
    {
        ...
        if (plotPrefs.isShowDataGaps(false) != showGapsCheckbox.isSelected())
        {
            ...
            // Remove or restore the data gaps based on the check box selection and update the
            // plots and data dialogs
    ...
    private void updateOverrun()
    {
        ...
        if (plotPrefs.isShowOverruns(false) != showOverrunsCheckbox.isSelected())
        {
            ...
            // Remove or restore the overrun indicators based on the check box selection and update
            // the plots
            if (stepPlot != null)
            {
    ...
    /**********************************************************************************************
     * Check for changes and update the display of vertical grid lines on the step and thread of
     * execution plots
     *********************************************************************************************/
    private void updateVerticalGridLine()
    {
        ...
        if (plotPrefs.isShowPlotVerticalGrid(false) != verticalGridCheckbox.isSelected())
        {
            ...
            // Draw or hide the vertical grid lines, if applicable, and if the plot exists
            if (stepPlot != null)
            {
    ...
    /**********************************************************************************************
     * Check for changes and update the display of horizontal grid lines on the step and thread of
     * execution plots
     *********************************************************************************************/
    private void updateHorizontalGridLine()
    {
        ...
        if (plotPrefs.isShowPlotHorizontalGrid(false) != horizontalGridCheckbox.isSelected())
        {
            ...
            // Draw or hide the horizontal grid lines, if applicable, and if the plot exists
            if (threadPlot != null)
            {
    ...
    /**********************************************************************************************
     * Check for changes and update the display of the CPU idle time on the statistics pie charts
     *********************************************************************************************/
    ...
    /**********************************************************************************************
     * Check for changes and update the minor and major frame IDs and line colors
     *********************************************************************************************/
    private void updateMinorMajorFrame()
    {
        ...
        // Check if the user changed the minor or major frame display selections or IDs
                                         ...
                                         majorIDComboBox.getSelectedItem()))
        {
            ...
            // Step through the IDs and save the minor and major performance IDs. Save the ID
            // instead of the ID text since the text can be changed
            for (PerformanceID pid : perfIDs.getPerfIDList())
            {
        ...
        if (frameChanged)
        {
            // Draw or hide the minor and major frame markers, if applicable, and if the plot
            // exists
            if (stepPlot != null)
            {
