...
TEST(ProtobetterTestA, BasicUsage)
{
	Bittylicious_a mystruct;
	Bittylicious_a mystruct2;

	unsigned char buffer[STRUCT_BITTYLICIOUS_A_PACKED_SIZE];
	...
	PackBittylicious_a(buffer, &mystruct);
	UnpackBittylicious_a(&mystruct2, buffer);
